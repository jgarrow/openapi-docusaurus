...
# Introduction to Account and Routing Numbers

MX's Instant Account Verification (IAV) feature allows partners to access account and routing numbers. When used in combination with Account Owner Verification (AOV) and Balance Checks, account numbers can be used for a number of purposes, such as money movement through the ACH system and fraud reduction.

This guide will take you through the process of getting this information using the Connect Widget or purely through API endpoints. After reading this guide you'll be able to:
