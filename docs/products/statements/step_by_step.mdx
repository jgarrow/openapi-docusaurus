...
You can now see all the statements that are available to download. Make a special note of the `uri` field. This will be used in the next step to download a particular statement PDF.
