...
The first step is to create a user. A user represents your end user in the MX Platform. Make a POST request to the [create user](/api#core_resources_users_create_user) endpoint, as shown below.
